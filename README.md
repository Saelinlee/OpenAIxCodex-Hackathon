...
1. **The complaint is messy.** It arrives as a forwarded email, a hotline note, or a manager's escalation. Facts, opinions, and emotional context are tangled. Specific dates, names, and channels are often missing.
